...
gulp.task("wooc", function(){
    return gulp.src("./sass/woocommerce.scss")
        ...
        .pipe(gulp.dest("."))
        .pipe(livereload())
        .pipe(notify({message: "wooc task finalizada"}))
});
...
gulp.task("watch", function(){
    ...
    gulp.watch("./sass/**/*.scss", ["wooc"])
    gulp.watch("./js/custom/**/*.js", ["javascript"])
    gulp.watch("./images/raw/**/*.*", ["imagemin"])
});

gulp.task("default", ["sass","wooc", "javascript", "imagemin", "watch"], function(){
